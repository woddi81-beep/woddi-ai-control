...
def load_settings() -> Settings:
    ...
    return Settings(
        ...
        files_allow_outside_project=_bool_setting(runtime, "files", "allow_outside_project", "WODDI_AI_CONTROL_FILES_ALLOW_OUTSIDE_PROJECT", True),
        ...
        netbox_base_url=_string_setting(runtime, "netbox", "base_url", "MONO_NETBOX_BASE_URL", "https://netbox-dev.global.cloud.sap/api").rstrip("/"),
